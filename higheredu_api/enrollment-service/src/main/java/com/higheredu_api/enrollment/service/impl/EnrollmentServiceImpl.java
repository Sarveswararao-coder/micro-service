...
public class EnrollmentServiceImpl implements EnrollmentService {
    ...
    public ResponseDto getEnrollment(Long enrollmentId) {
        ...
        responseDto.setEnrollment(new EnrollmentDto(enrollment.getId(), enrollment.getName(), enrollment.getEmail(), 
                            enrollment.getStudentId(), enrollment.getDepartmentId(), enrollment.getCourseId()));
